...
export default function Hero(): JSX.Element {
  return (
    <div className="default-margin flex h-screen flex-col items-center justify-center bg-topo-texture-mobile bg-cover shadow-[inset_0_0_300px_100px_#000000] sm:bg-topo-texture-desktop">
